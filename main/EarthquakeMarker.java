...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public EarthquakeMarker (PointFeature feature) {
		...
		if(magnitude < THRESHOLD_LIGHT) {this.radius = 5;}
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		// TODO: draw X over marker if within past day
		String age = getProperty("age").toString();
		if (age.equalsIgnoreCase("Past Day") || age.equalsIgnoreCase("Past Hour")){
	...
	/** Determine whether a city is in the threatCircle of a EarthquakeMarker.
	 * Return true if yes, false otherwise.
	 */
	public boolean isInThreat(Marker city) {
		// the distance between the quake and city is smaller than the threat radius
